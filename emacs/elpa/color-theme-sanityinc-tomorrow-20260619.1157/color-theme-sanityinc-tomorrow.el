...
;; Package-Version: 20260619.1157
;; Package-Revision: 9ce4bc783acc
  ...
  (quote
   (mapcar
    ...
    `(;; Standard font lock faces
      ...
      (gnus-group-mail-1-empty (:foreground ,comment))
      (gnus-group-mail-2 (:foreground ,purple :weight normal))
      (gnus-group-mail-2-empty (:foreground ,comment))
      (gnus-group-mail-3 (:foreground ,aqua :weight normal))
      (gnus-group-mail-3-empty (:foreground ,comment))
      (gnus-group-mail-4 (:foreground ,yellow :weight normal))
      (gnus-group-mail-4-empty (:foreground ,comment))
      (gnus-group-mail-5 (:foreground ,orange :weight normal))
      (gnus-group-mail-5-empty (:foreground ,comment))
      (gnus-group-mail-6 (:foreground ,blue :weight normal))
      (gnus-group-mail-6-empty (:foreground ,comment))
      ...
      (gnus-group-news-1-empty (:foreground ,comment))
      (gnus-group-news-2 (:foreground ,purple :weight normal))
      (gnus-group-news-2-empty (:foreground ,comment))
      (gnus-group-news-3 (:foreground ,aqua :weight normal))
      (gnus-group-news-3-empty (:foreground ,comment))
      (gnus-group-news-4 (:foreground ,yellow :weight normal))
      (gnus-group-news-4-empty (:foreground ,comment))
      (gnus-group-news-5 (:foreground ,orange :weight normal))
      (gnus-group-news-5-empty (:foreground ,comment))
      (gnus-group-news-6 (:foreground ,blue :weight normal))
      (gnus-group-news-6-empty (:foreground ,comment))
